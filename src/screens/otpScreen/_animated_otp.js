...
// const OTP = ({ dispatch, activeTheme, navigation, behavior }) => {
...
//     // if (cellNoCheck) Keyboard.dismiss();
//     let tempData = [
//         {
//             "name": "Pakistan",
//             "topLevelDomain": [
...
//     }
//     const setSelectedValue = (itemIndex, itemValue) => {
//         // console.log('Ran-----', itemIndex, itemValue);
//         togglePicker(false)
//         setState({ ...state, countryCode: itemValue });
//     };
//     const onChangeNumberHandler = value => {
//         // const { } = e.nativeEvent;
//         // console.log('value :', value)
//         // let validateInput = Validator.isNumeric(value);
//         let newValue = null;
//         if (!cellNo.length && value == '0') newValue = '';
//         else if (value[0] == '0') {
//             console.log('Zero on start true-----',);
//             let slicedVal = value.slice(1, value.length);
//             newValue = slicedVal;
...
//             newValue = value;
//         }
//         setState({ ...state, cellNo: newValue, isValid: Validator.isNumeric(value) });
//         // console.log('cellNoCheck :', cellNoCheck);
//     };
//     const onSuccessHandler = response => {
//         console.log("Otps sent:--- ,", response.data);
//         Alert.alert(response.data.message);
//         clearState();
//         navigation.navigate('Code', { 'paramsData': response.config.data });
//     };
...
//             data = {
//                 'phoneNumber': countryCode + cellNo,
//                 'appHash': appHash[0]
//             };
...
//             };
//         }
//         dispatch(userAction({ phoneNumber, appHash }));
//         postRequest('/api/User/OTP/Send', data, {}, dispatch, onSuccessHandler, onErrorHandler, '');
//     };
//     const clearState = () => setState(initState);
//     // console.log('state :', state);
//     const _keyboardShowDetecter = keyboardState => {
//         sharedAnimationHandler(animation, 1.5, 1000);
//         setState(prevState => ({ ...prevState, keypaidOpen: true }));
//     }
...
//                                     maxLength={10}
//                                     value={cellNo} onChangeText={onChangeNumberHandler}
//                                     autoFocus
//                                     onFocus={() => {
//                                         sharedAnimationHandler(gradientView, 1, 1000)
//                                         sharedAnimationHandler(animation, 1.5, 1000)
//                                     }} />
//                                 {
...
//                             marginVertical: 20
//                         }}>We will send you One Time Password (OTP) to your mobile number.</Text>
//                         <View style={{ flex: 1, flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end', }}>
//                             <SubmitBtn
//                                 title="Send OTP"
//                                 activeTheme={activeTheme}
//                                 style={styles.appButtonContainer(!cellNoCheck || !isValid ? activeTheme.grey : activeTheme.default, !cellNoCheck || !isValid ? 0.5 : undefined)}
