...
function RestaurantDeals(props) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#F5F6FA' }}>
            ...
            {props.stackState.keypaidOpen===false&&<SharedFooter activeTab={null} activeTheme={activeTheme} mainDrawerComponentProps={props} drawerProps={props.navigation.drawerProps} onPress={onFooterItemPressed} />}
        </View>
    )
}
