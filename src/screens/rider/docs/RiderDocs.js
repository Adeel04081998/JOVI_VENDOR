...
import { View, Text, Image, ScrollView, KeyboardAvoidingView, BackHandler, Platform, ImageBackground, StyleSheet, TouchableOpacity, Keyboard, Dimensions, Linking, PermissionsAndroid } from 'react-native';
...
import { renderPicture, sharedImagePickerHandler, navigateWithResetScreen, sharedIsRiderApproved, sharedConfirmationAlert } from '../../../utils/sharedActions';
