...
function CustomerOrder({ navigation, route, userObj }) {
    ...
    useEffect(() => {
        ...
        getHubConnectionInstance("JobCompleted")?.on("JobCompleted", (isOrderCompleted, jobId, orderId, timeEnd = "TODO") => {
            console.log(`RECEIVED -> 'JobCompleted' :`, [isOrderCompleted, jobId, orderId, timeEnd]);
