...
const stylesHome = StyleSheet.create({
    ...
    homeTabCounter:(props)=>{return { flex: 0.1, width: 5, height: 30, margin: 3, justifyContent: 'center', alignItems: 'center', borderColor: props.activeTheme.background, borderWidth: 1, borderRadius: 140, backgroundColor: props.activeTheme.background }}
