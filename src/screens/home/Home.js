...
function Home(props) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            >
                <Text style={{ ...commonStyles.fontStyles(20, props.activeTheme.white, 4), left: 20, flex: 0.7, }}>Jovi</Text>
                <TouchableOpacity style={{ flex: 1, alignItems: 'center', zIndex: 1 }} onPress={() => { }}>
                    <LinearGradient
                        colors={['#8168C9', '#413465']}
                        style={{
                            // left: 20,
            ...
            <Text style={{ ...commonStyles.fontStyles(18, props.activeTheme.black, 4), marginLeft: 20 }}>Promotions</Text>
